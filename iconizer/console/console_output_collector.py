...
from iconizer.cross_platform_utils.process_utils import CrossPlatformProcessUtils
...
class ConsoleOutputCollector(object):
    ...
    def start_app_and_collect_logs(self, app_or_script_path_and_param_list, console_window):
        ...
        p = self.cross_platform_create_process()
    ...
    def cross_platform_create_process(self):
        try:
            return subprocess.Popen(self.real_execute_path_and_param_list, cwd=self.cwd, stdout=subprocess.PIPE,
    ...
    def update_process_priority(self, app_or_script_path_and_param_list, p):
        CrossPlatformProcessUtils().update_process_priority(app_or_script_path_and_param_list, p)
    ...
    def kill_console_process_tree(self):
        ...
        for i in self.process_list:
            CrossPlatformProcessUtils().kill_process(i)
